...
const dataDoEvento = new Date("Apr 12, 2024 19:00:00");
...
const contaAsHoras = setInterval(function() {
    ...
    document.getElementById('contador').innerHTML = `${diasAteOEvento}d ${horaAteOEvento}hr ${minAteOEvento}min ${segAteOEvento}s`;
